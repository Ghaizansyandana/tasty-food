...
<body>
    <div class="login-container">
        ...
        <div class="back-link mt-3 text-center">
            <span class="text-muted" style="font-size:14px;">Belum punya akun?</span> <a href="{{ route('register') }}" class="text-decoration-none" style="color: #667eea; font-weight:600;">Daftar di sini</a>
            <br><br>

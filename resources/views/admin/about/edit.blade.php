                ...
                <form action="{{ route('admin.about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-2">
                            ...
                            <img src="{{ asset('storage/' . $about->image) }}" class="rounded-3" style="width: 200px; height: 120px; object-fit: cover;">
                        </div>
                        <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image">
                        <div class="form-text">Biarkan kosong jika tidak ingin mengubah gambar. Maks 2MB.</div>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary py-3 fw-bold rounded-3">Perbarui Konten</button>
                    </div>
                </form>
            </div>
        </div>
